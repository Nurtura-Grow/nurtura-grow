            ...
            <div class="block lg:grid grid-cols-2 gap-4">
                ...
                <div class="h-screen lg:h-auto flex py-5 px-5 lg:py-0 lg:my-0">
                    <div
                        ...
                        <form method="POST" action="{{ route('auth.password') }}" class="intro-x mt-8 w-full">
                            @csrf
                            ...
                            <div class="intro-x mt-5 lg:mt-8 text-center lg:text-left">
                                <button type="submit" class="w-full btn text-white shadow-md" style="background-color: rgb(0, 38, 35);" id="buttonTambah">
                                    Kirim Kode
                                </button>
                            </div>
                        </form>
